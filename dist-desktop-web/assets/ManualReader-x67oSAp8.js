import{u as sa,g as na,r as p,m as P,j as e,e as _,d as re}from"./index-DH08CNbe.js";import{S as oa}from"./SearchableSelect-DYrEyZed.js";const la="fa-book",ca="#64748b",A=x=>{const s=(x||"").toLowerCase();return s.includes("ürün")||s.includes("urun")?"fa-utensils":s.includes("hammad")?"fa-wheat-awn":s.includes("ekipman")?"fa-gears":s.includes("operasyon")?"fa-clipboard-check":s.includes("hizmet")?"fa-star":la},$=x=>{const s=(x||"").toLowerCase();return s.includes("ürün")||s.includes("urun")?"#f59e0b":s.includes("hammad")?"#10b981":s.includes("ekipman")?"#6366f1":s.includes("operasyon")?"#0ea5e9":s.includes("hizmet")?"#ec4899":ca};function q(x){if(!x)return null;const s=x.split(`
