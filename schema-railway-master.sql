...
CREATE TABLE IF NOT EXISTS public.company_nodes (
  ...
  CONSTRAINT company_nodes_parent_legal_entity_id_fkey FOREIGN KEY (parent_legal_entity_id) REFERENCES public.company_nodes(id) ON DELETE SET NULL
);
...
-- ==============================================================================
-- SuitableRMS E-Fatura & E-Dönüşüm FAZ 1 Şeması (UBL-TR 2.1 Standardı)
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS public.e_invoices (
  ...
  status_code INTEGER NOT NULL DEFAULT 1000, -- 1000, 1100, 1120, 1163, 1200, 1300, 1301, 9999
