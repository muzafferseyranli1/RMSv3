...
- \`Current Capability\`:
  ...
  - Butonların (\`button\`) stili \`display: grid\` yerine \`display: flex\` ve dikey yönelimli (\`flexDirection: column\`) hale getirilerek dikeyde esneme/uzama yapması engellendi.
