...
export const CONDITION_LIBRARY = [
  ...
  { key: 'period_product_quantity', label: 'Dönem içindeki ürün miktarı', description: 'Müşterinin dönem boyunca satın aldığı seçili ürün/kategori miktarını kontrol eder.' },
