...
export const CONDITION_KEY_STATUS = {
  ...
  happy_hour: { category: 'server', label: 'Happy hour' },
  gift_card_series: { category: 'server', label: 'Hediye kartı serisi' },
  campaign_triggered: { category: 'server', label: 'Kampanya tetiklendi' },
  coupon_present: { category: 'server', label: 'Kupon mevcut' },
  ...
  missing_products: { category: 'model', label: 'Eksik ürünler' },
